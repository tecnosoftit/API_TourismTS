...
using Sabre.SWS_BargainFinderMaxRQ;

namespace Sabre.Air
{
    class BargainFinderMaxRq
    {
        /// <summary>
        /// Returns 50, 100, 200  itineraries in the response. The action code in the SOAP header must be set to BargainFinderMaxRQ.
        /// </summary>
